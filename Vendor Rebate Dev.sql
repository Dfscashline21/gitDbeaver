...
WITH test AS (SELECT ci.brand_name,tr.REBATE_billing_method,'UPDATE',tr.sku,ci.description, tr.REBATE_TYPE,tr.REBATE_BILLING_PERIOD,tr.REBATE_START_DATE, tr.REBATE_END_DATE, tr.TRAN_QTY ,tr.TRAN_AMT ,tr.TRAN_COGS_AMT ,tr.REBATE_PERCENTAGE,tr.REBATE_DOLLAR_AMOUNT,tr.TRAN_AMT  
...
SELECT tt.*,mt.BILLING_CUSTOMER_ID ,mt.VENDOR_ID  FROM test tt
...
SELECT DISTINCT BRAND_ID,BRAND_RECORDS_NAME ,BILLING_CUSTOMER_ID ,VENDOR_ID  FROM ods.NS_VENDOR_REBATES 
...
CREATE TABLE TM_IGLOO_ODS_STG.ods.BILLING_METHOD (
	BILLING_METHOD_EXTID VARCHAR(255),
	DATE_CREATED TIMESTAMP ,
	IS_RECORD_INACTIVE VARCHAR(1) ,
	LAST_MODIFIED_DATE TIMESTAMP ,
	LIST_ID NUMBER(35,0) ,
	LIST_ITEM_NAME VARCHAR(999),
	CONSTRAINT BILLING_METHOD_PK PRIMARY KEY (LIST_ID)
);

GRANT ALL ON  TM_IGLOO_ODS_STG.ODS.BILLING_METHOD TO ODS_DEVS


SELECT * FROM ods.billing_method