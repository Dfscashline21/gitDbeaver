...
WHERE ci.ITEM_NAME ='049508006206'

SELECT * FROM ods.TRANSACTIONS_PROD  tr 
WHERE tr.TRAN_GL_DATE  BETWEEN $P{start_date} AND $P{end_date} AND tr.TRAN_SUB_TYPE_ID =16 AND tr.sku ='856069005643'

SELECT * FROM TM_IGLOO_ODS_STG.ods.TRANSACTIONS tr WHERE tr.TRAN_SUB_TYPE_ID =112