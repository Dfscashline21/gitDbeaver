...
getBrandMarketing =   """
                ...
                , ct.FULL_NAME , bil.LIST_ITEM_NAME as billing_method,sysdate().cnt.EMAIL from Administrator.VENDOR_FUNDING__BRAND_MARKETI bm
...
spPostBrandMarketing = {
                  ...
                  UPDATE ods.BRAND_MARKETING 
                      ...
                      BRAND_MARKETING.EMAIL = upd.EMAIL
