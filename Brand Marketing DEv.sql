...
SELECT 300,'Brand Marketing Fees',bm.START_DATE,'order','1',bm.ODS_PROCESSED_DATE,112,bm.START_DATE ::date ,bm.TOTAL_COST, bm.VENDOR_FUNDING__BRAND_MARKE_ID  FROM ods.brand_marketing bm
