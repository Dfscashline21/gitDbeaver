...
GRANT ALL ON  ODS.BRAND_MARKETING  TO ODS_DEVS
...
SELECT tr.TRAN_GL_DATE, bm.BRAND_RECORDS_NAME ,bm.BILLING_METHOD,bm.VENDOR_FUNDING_ITEM ,bm.ASSET_DESCRIPTION ,bm.MM_EMAIL ,bm.START_DATE ,bm.END_DATE ,bm.BILLING_MONTH_ID,tr.TRAN_AMT  FROM ods."TRANSACTIONS" tr 
LEFT JOIN ods.BRAND_MARKETING bm ON bm.VENDOR_FUNDING__BRAND_MARKE_ID = tr.BRAND_MARKETING_ID 
WHERE tr.TRAN_SUB_TYPE_ID =112